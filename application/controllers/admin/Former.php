...
class Former extends BaseController {
	...
	public function getAll()
	{
        ...
        $data["formers"] = $this->model_former->getAllWithRelations();
        $data['params'] = $this->getParams();
        $data['params']["config_params"] = $this->model_params->getConfigParams();
        $this->load->view('admin/former/index',$data);
	}
	...
	public function create()
	{
        ...
        $data['subjects'] = $this->model_subject->getAll('subject',array('deleted'=>'false'));
        $this->load->view('admin/former/create',$data);
	}
	...
	public function editFormer($id)
	{
        ...
        $this->load->model('model_subject');
        $data['params'] = $this->getParams();
        $data["former"]=$this->model_former->getById('former',$id);
        $data["user"]['position']='Trainee';
        $data['subjects'] = $this->model_subject->getAll('subject',array('deleted'=>'false'));
        $this->load->view('admin/former/editFormer',$data);
	}
