                        ...
                        <form class="sendForm">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="field1" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="field2" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="turnOver" name="turnOver" placeholder="Chiffre d'affaire" required="required"
                            ...
                            <div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="gsm" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                            ...
                            <div id="contact2" class="collapse">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="phone2" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="gsm2" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                            ...
                            <div id="contact3" class="collapse">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="phone3" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="gsm3" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="email" id="email3" name="email3" placeholder="email"
                                               class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                            </div>
...
<script>
    var createCompany_url="<?php echo base_url('admin/api/company/apiAdd'); ?>";
</script>

<script src="<?php echo base_url('assets/build2/js/company/create.js'); ?>"></script>
