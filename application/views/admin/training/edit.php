...
<!--                                                    <option value="0">Aucune</option>-->
                                                    <?php foreach ($companies as $company) {
                                                        $selected='';
                                                        if($company['id']===$training['company']){
                                                            $selected='selected';
                                                        }
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="former">
                                                    ...
                                                    <?php foreach ($formers as $former) {
                                                        $selected='';
                                                        if($former['id']===$training['former']){
                                                            $selected='selected';
                                                        }
                                                        ?>
                                                        <option <?php echo $selected; ?> value="<?php echo $former['id']; ?>"><?php echo $former['first_name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="subject">
                                                    ...
                                                    <?php foreach ($subjects as $subject) {
                                                        $selected='';
                                                        if($subject['id']===$training['subject']){
                                                            $selected='selected';
                                                        }
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                foreach ($training_dates as $training_date) {
                                                    if($training_date['date']!=='00-00-0000'){
                                                        $value.=$training_date['date'].',';
                                                    }
                                                }
                                                ?>
                                                <input value="<?php echo $value; ?>" name="dates" placeholder="Dates de formation" type="text" class="form-control date"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            ...
                                                            ?>
                                                            <label><input <?php echo $checked; ?> type="checkbox" name="publish"/> Publier la synthèse de formation</label>
                                                        </div>
                                                    </div>
...
<script>
    ...
    var editCourse_url='<?php echo base_url("admin/api/training/apiEdit"); ?>';
