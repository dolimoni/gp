                                ...
                                <?php foreach ($allUsers as $user) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button data-id="<?php echo $user['id']; ?>" class="btn btn-danger delete btn-xs"><i class="fa fa-tash"></i> Supprimer</button>
...
<script>
    var deleteUser_url='<?php echo base_url("admin/trainee/apiDeleteUser"); ?>';
</script>
        ...
        $('button.delete').on('click',function () {
           ...
           var data={
            ...
            swal({
                ...
                function () {
                    apiRequest(deleteUser_url,data);
                }
            );
        });
    });
