                    ...
                    <div class="form-horizontal form-label-left" novalidate>
                        ...
                        <form class="sendForm">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="experience" name="experience" placeholder="Nombre d'année d'expérience" required="required"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="certificated" type="checkbox" name="certificated"
                                           class="form-control col-md-7 col-xs-12"/>
                                </div>
                            </div>
                            <div class="item form-group">
...
<script>
    var createFormer_url="<?php echo base_url('admin/api/former/apiAdd'); ?>";
    var upload_url="<?php echo base_url('admin/image/upload'); ?>";
    var uploads={};
</script>

<script src="<?php echo base_url('assets/build2/js/former/create.js'); ?>"></script>
