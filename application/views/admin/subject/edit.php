                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <input value="<?php echo $subject['title']; ?>" type="text"
                                               class="form-control toBeValidated"
                                               data-required="true"
                                               name="title"
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <textarea  type="textarea" class="form-control" name="description"
                                                  placeholder="Description"><?php echo $subject['Description']; ?></textarea>
                                    </div>
                                </div>
                                <div class="x_title">
                                    <h3>Synthèse</h3>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <textarea rows="6" type="textarea" class="form-control" name="synthesis_description"
                                                  placeholder="Description"><?php echo $subject['ss_description']; ?></textarea>
                                    </div>
                                    <div class="col-xs-12">
                                        <label for="title">Url</label>
                                        <input value="<?php echo $subject['url']; ?>" type="text" class="form-control" name="url" id="url"
                                               placeholder="Url" />
                                    </div>
                                </div>
                                <br/>
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <button class="btn btn-success sendForm" type="submit" name="add" value="<?= lang("add"); ?>">Modifier</button>
                                    </div>
                                </div>
                                ...
                                <div class="text-center hidden">
                                    <input class="btn btn-success" type="submit" name="add" value="<?= lang("edit"); ?>"/>
                                </div>
                            </fieldset>
...
<script src="<?php echo base_url('assets/build2/js/subject/edit.js'); ?>"></script>

<script>
    var allSubjects_url;
    var base_url="<?php echo base_url(); ?>";
    var editSubject_url="<?php echo base_url('admin/api/subject/apiEdit'); ?>";
